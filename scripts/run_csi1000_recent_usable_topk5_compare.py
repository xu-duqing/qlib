...
RUN_ID = datetime.now().strftime("%Y%m%d_%H%M%S") + "_csi1000_recent_usable_topk5"
...
RUNS = {
    "linear_recent2y": "examples/benchmarks/Linear/workflow_config_linear_Alpha158_csi1000_recent2y_topk5.yaml",
    "lightgbm_recent2y": "examples/benchmarks/LightGBM/workflow_config_lightgbm_Alpha158_csi1000_recent2y_topk5.yaml",
    "linear_recent3y": "examples/benchmarks/Linear/workflow_config_linear_Alpha158_csi1000_recent3y_topk5.yaml",
    "lightgbm_recent3y": "examples/benchmarks/LightGBM/workflow_config_lightgbm_Alpha158_csi1000_recent3y_topk5.yaml",
}
...
for item in results:
    ...
    model = item["name"].replace("_recent2y", "").replace("_recent3y", "")
    lines.append(
